"""
Django settings for fore_titans project.
...
SECRET_KEY = 'django-insecure-zxfz9p%_(%n4rxy=*so@^k$og11m*t%&46zmwlye-=k(v^dc)c'
...
WSGI_APPLICATION = 'fore_titans.wsgi.application'
